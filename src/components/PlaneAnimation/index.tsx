  ...
  return (
    <div>
      <div className={`${styles.scene}`}>
        <span className={`${styles.cloud} ${styles['cloud--small']}`} />
        <svg xmlns='http://www.w3.org/2000/svg' id='plane' className={`${styles.plane}`} viewBox='0 0 104 47' x='0' y='0' width='104' height='47' background-color='#ffffff00'>
          <g id='avion'>
        ...
        <span className={`${styles.cloud} ${styles['cloud--medium']}`} />
        <span className={`${styles.cloud} ${styles['cloud--large']}`} />
      </div>
